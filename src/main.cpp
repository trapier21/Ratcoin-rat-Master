...
const string strMessageRatCoin = "RatCoin Signed Message:\n";
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // RatCoin: check proof-of-stake block signature
...
// RatCoin: attempt to generate suitable proof-of-stake
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //block.GetHash() == 00000e255beb9a723f7740cafe56a424d65d293b284facb0686569e4d9cc1dc0
        //block.hashMerkleRoot == 281439d16cd31f6db45813201f95407d4d84443fe5e9cd5c7e08317d9697adf3
        //block.nTime = 1540579640 
        //block.nNonce = 138203

        const char* pszTimestamp = "RatCoin for world economy October 2018";
        CTransaction txNew;
        txNew.nTime = 1540579640;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = !fTestNet ? 138203 : 0;
	...
	fflush(NULL);
        ...
        assert(block.hashMerkleRoot == uint256("0x281439d16cd31f6db45813201f95407d4d84443fe5e9cd5c7e08317d9697adf3"));
